...
(function() {
  ...
  this.Chosen = (function(_super) {
    ...
    Chosen.prototype.set_default_values = function() {
      ...
      this.multi_temp = new Template('<ul class="chosen-choices"><li class="search-field"><input type="text" value="#{default}" class="default" autocomplete="off" style="width:25px;margin-left:10px;margin-top:5px;" /></li></ul><div class="chosen-drop"><ul class="chosen-results"></ul></div>');
